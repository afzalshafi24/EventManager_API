...
class DB_Handler():
    ...
    def get_event_data(self, scid: int, event_name: str):
        ...
        data = session.query(eventData).filter(eventData.scid == scid, eventData.event_name == event_name).all()
    ...
    def get_all_data(self):
        ...
        data = session.query(eventData).all()
    ...
    def find_new_events(self, src_name):
        ...
        #Get data by source
        data = session.query(eventData).filter(eventData.event_src == src_name, eventData.spark_report_id == None).all()
